...
# Fetch Google's current stock price
ticker = 'GOOGL'
data = yf.Ticker(ticker)
current_price = data.history(period='1d')['Close'].iloc[-1]

# Parameters for the Black-Scholes model
S = current_price  # Current stock price of Google (GOOGL)
K = 2900  # Strike price (you can change this to any value)
...
# Print the results
print(f"Google (GOOGL) Current Stock Price: {S:.2f}")
...
# Google (GOOGL) Current Stock Price: 2738.50
# Strike Price: 2900
# Time to Expiration (years): 1.10
# Risk-Free Interest Rate: 0.05
# Volatility: 0.30
# Call Option Price: 238.45
# Put Option Price: 326.72